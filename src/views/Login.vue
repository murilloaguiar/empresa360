...
export default {
   ...
   methods: {
      navegarPara(){
         ...
         //coletar os dado de email e senha
         //realizar um requisição http de autenticação
         //receber o token de autorização

         this.$router.push('/home') //semelhante a propriedade to de router-link
         //this.$router.push({path: '/home'})
         //this.$router.replace('/home')
         //this.$router.replace({ path: '/home'})
         //this.$router.forward()
         //this.$router.back()
         //this.$router.go(2) //positivo para avançar e negativo para retroceder
